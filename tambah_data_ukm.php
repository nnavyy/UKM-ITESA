...
<div class="col-sm-12">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="" method="post" enctype="multipart/form-data" class="ukm-form">

                <div class="form-group">
                    <label for="recipient-name" class="control-label">Nama UKM</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control-file" type="file" name="ukm_image" id="ukm_image" accept="image/*" required>
                </div>
                ...
                if($_SERVER['REQUEST_METHOD']=='POST'){
                    ...
                    $simpan = mysqli_query($koneksi, "INSERT INTO tb_ukm(nama, logo) VALUES ('$nama', '$logo')");
                    echo "<meta http-equiv='refresh' content='1;url=http://localhost:8080/e-rakyat/profil_ukm.php'>";
                }
                ?>
